...
from em_data_chat.utils.state import AgentState
from pydantic import BaseModel
from langgraph.graph import END
from langgraph.prebuilt import ToolNode
from typing import List, Tuple
from langchain_core.messages import AnyMessage, SystemMessage, HumanMessage, AIMessage, ChatMessage
from em_data_chat.utils.prompts import RESEARCH_PLAN_PROMPT, WRITER_PROMPT, FINAL_REVIEW_PROMPT
from em_data_chat.utils.tools import tavily_client
from em_data_chat.utils.article_summarizer import generate_summaries
import concurrent.futures
from datetime import datetime
from em_data_chat.utils.tools import financial_calculator
import logging
    ...
    messages = [
        SystemMessage(
            content=WRITER_PROMPT.format(
                content=content, data=state['data'], current_date=current_date)
        ),
        user_message
    ]
    model_name = config.get('configurable', {}).get("model_name", "openai")
