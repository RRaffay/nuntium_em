...
def article_summarizer(url: str, model: int = 3, max_length: int = 20000, timeout: int = 30) -> str:
    """
    ...
    timeout (int, optional): The timeout in seconds for generating the summary. Defaults to 30 seconds.
...
def generate_summaries(article_urls: List[str], max_workers: int = 10, timeout: int = 30) -> List[str]:
    """
